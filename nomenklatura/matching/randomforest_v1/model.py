...
from nomenklatura.matching.randomforest_v1.names import first_name_match
from nomenklatura.matching.randomforest_v1.names import family_name_match
from nomenklatura.matching.randomforest_v1.names import name_levenshtein, name_match
from nomenklatura.matching.randomforest_v1.names import name_token_overlap, name_numbers
from nomenklatura.matching.randomforest_v1.misc import phone_match, email_match
from nomenklatura.matching.randomforest_v1.misc import address_match, address_numbers
from nomenklatura.matching.randomforest_v1.misc import identifier_match, birth_place
...
class RandomForestV1(ScoringAlgorithm):
    """A simple matching algorithm based on a random forest model."""
