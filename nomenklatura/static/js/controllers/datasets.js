...
nomenklatura.controller('DatasetsViewCtrl', ['$scope', '$routeParams', '$location', '$http', '$modal', '$timeout', 'session',
		function($scope, $routeParams, $location, $http, $modal, $timeout, session) {
	$scope.dataset = {};
	$scope.entities = {};
	$scope.new_entity = {};
	$scope.query = '';
