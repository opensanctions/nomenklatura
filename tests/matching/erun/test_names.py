...
def test_person_name_similarity_orders_exact_typo_and_unrelated_names():
    ...
    assert (
        person_name_levenshtein(e("Company", name="Acme"), e("Company", name="Acme"))
        == 0.0
    )
...
def test_organization_and_legal_entity_name_features_obey_schema_gates():
    ...
    assert (
        org_name_levenshtein(e("Person", name="Acme"), e("Person", name="Acme")) == 0.0
    )
...
def test_family_name_match_distinguishes_agreement_conflict_and_missingness():
    ...
    assert (
        family_name_match(e("Company", name="Smith"), e("Company", name="Smith")) == 0.0
    )
...
def test_object_name_similarity_is_strict_and_schema_limited():
    ...
    assert (
        obj_name_levenshtein(e("Company", name="Acme"), e("Company", name="Acme"))
        == 0.0
    )
